          ...
          {!isOpen && (
            ...
            >
              <div className="flex flex-col gap-4 w-full max-w-xl md:gap-6 lg:gap-8">
                ...
                >
                  Solizone lets Ethereum developers write, test, and deploy Solidity on an execution layer secured by Logos. Join the list for early access to Solizone EVM, Zoner, and Basecamp integration.
                </motion.p>
              </div>
            </motion.div>
          )}
          ...
          {isOpen && (
            ...
            >
              <article className="relative overflow-y-auto italic p-6 h-full [&_p]:my-4">
                <p>
                  &quot;Ethereum gave developers a shared language for programmable systems. Solidity, the EVM, and the tooling around them represent years of hard-won knowledge, battle-tested patterns, and a community that knows how to build. Logos offers something different: a sovereign base layer built for ordering, availability, and finality, with zones that let new execution environments stand on their own. Solizone exists to connect the two.
                </p>
                <p>
                  We believe developers shouldn't have to start over to build somewhere new. Your contracts, your tests, and your mental model should carry across. We believe in clear boundaries: execution belongs to Solizone, settlement belongs to Logos, and neither should blur into the other. We believe in verifiability over trust. Every block we produce is committed, published, and finalized in the open, where anyone can check it. And we believe infrastructure is best built in public, one proven step at a time.
                </p>
                <p>
                  Our promise is to ship things that work before we talk about them. Solizone EVM already executes Solidity and publishes its blocks to Logos, where they reach finality. Zoner and our Basecamp integration come next, built on the same foundations.
                </p>
                <p>
                  If you write Solidity and care about where your code runs, build with us.&quot;
                </p>
              </article>
            </motion.div>
          )}
